              ...
              <>
                ...
                <div className="flex items-center gap-6 mr-4">
                  ...
                  >
                    ...
                    {unreadCount > 0 && (
                      <span className="absolute -top-1.5 -right-1.5 bg-red-500 text-white text-[9px] font-bold px-1.5 py-0.5 rounded-full flex items-center justify-center min-w-4 h-4 border border-[#111827]">
                        {unreadCount}
                      </span>
                    )}
                    <span className="text-[10px] mt-1 font-medium hidden md:block">
